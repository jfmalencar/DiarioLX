...
INSERT INTO users (username, email, role, password_hash, first_name, last_name, bio, active_account, created_at, updated_at) VALUES ('pedro.martins','pedro@example.com','CONTRIBUTOR','$2a$10$zx51.oyueMBIcSjfxsxOJ.rew4kfDdpSDaZcJIGbYTHpJGklWpouu','Pedro','Martins','Repórter de cidade.',TRUE,1700000100000,1700000100000);
INSERT INTO users (username, email, role, password_hash, first_name, last_name, bio, active_account, created_at, updated_at) VALUES ('rita.ferreira','rita@example.com','EDITOR','$2a$10$zx51.oyueMBIcSjfxsxOJ.rew4kfDdpSDaZcJIGbYTHpJGklWpouu','Rita','Ferreira','Editora de sociedade.',TRUE,1700000101000,1700000101000);
INSERT INTO users (username, email, role, password_hash, first_name, last_name, bio, active_account, created_at, updated_at) VALUES ('ines.matos','ines@example.com','CONTRIBUTOR','$2a$10$zx51.oyueMBIcSjfxsxOJ.rew4kfDdpSDaZcJIGbYTHpJGklWpouu','Inês','Matos','Jornalista de cultura.',TRUE,1700000102000,1700000102000);
INSERT INTO users (username, email, role, password_hash, first_name, last_name, bio, active_account, created_at, updated_at) VALUES ('miguel.lopes','miguel@example.com','CONTRIBUTOR','$2a$10$zx51.oyueMBIcSjfxsxOJ.rew4kfDdpSDaZcJIGbYTHpJGklWpouu','Miguel','Lopes','Repórter de política.',TRUE,1700000103000,1700000103000);
INSERT INTO users (username, email, role, password_hash, first_name, last_name, bio, active_account, created_at, updated_at) VALUES ('sofia.almeida','sofia@example.com','EDITOR','$2a$10$zx51.oyueMBIcSjfxsxOJ.rew4kfDdpSDaZcJIGbYTHpJGklWpouu','Sofia','Almeida','Editora multimédia.',TRUE,1700000104000,1700000104000);
INSERT INTO users (username, email, role, password_hash, first_name, last_name, bio, active_account, created_at, updated_at) VALUES ('duarte.neves','duarte@example.com','CONTRIBUTOR','$2a$10$zx51.oyueMBIcSjfxsxOJ.rew4kfDdpSDaZcJIGbYTHpJGklWpouu','Duarte','Neves','Jornalista de desporto.',TRUE,1700000105000,1700000105000);
...
INSERT INTO settings (key, value) VALUES
    ...
    ('contact.address',        E'Campus de Benfica do IPL\n1549-014 Lisboa'),
