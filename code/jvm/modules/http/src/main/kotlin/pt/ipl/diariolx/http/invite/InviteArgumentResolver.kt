...
class InviteArgumentResolver : HandlerMethodArgumentResolver {
    override fun supportsParameter(parameter: MethodParameter): Boolean = parameter.parameterType == Invite::class.java
    ...
    companion object {
        ...
        fun getInviteFrom(request: HttpServletRequest): Invite? = request.getAttribute(KEY) as Invite?
    }
}
