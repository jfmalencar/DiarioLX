          ...
          <div className='w-50'>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='text-end mb-4'>
                <Link to='/backoffice/forgot-password' className='small'>
              ...
              <div className='text-center mt-4'>
                ...
                <Link to='/backoffice/register' state={{ source: location.state?.source || '/backoffice' }} replace={true} className='ms-2'>
