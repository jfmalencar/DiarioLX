...
export function CodigoDeontologico() {
    return (
        <div className='container py-5'>
            <div className='mx-auto' style={{ maxWidth: 820 }}>
                <h1 className='fw-bold border-bottom border-2 border-dark pb-2 mb-5'>Código Deontológico</h1>
                <ol
                    style={{
                ...
                <p className='text-muted fst-italic mt-4' style={{ fontSize: '0.95rem' }}>
                    {APPROVAL}
                </p>
            </div>
        </div>
