...
em desenvolvimento activo. A autenticação é implementada através de JSON
Web Tokens (JWT), com tokens de acesso de curta duração e tokens de atualização
de longa duração armazenados em cookies \texttt{HttpOnly}, permitindo a validação
