...
\begin{itemize}
      \item \textbf{Editorial workflow}: the full content lifecycle --- draft, pending
            review, published, and rejected --- is implemented and enforced according
...
\begin{itemize}
      \item \textbf{Scheduled publishing}: allowing editors to set a future date and time
            at which approved content is automatically published.
      ...
      \item \textbf{Search engine optimisation}: enriching public pages with structured
            data, social preview (Open Graph) metadata, and a generated sitemap, improving
            how content is indexed by search engines and previewed when shared.
