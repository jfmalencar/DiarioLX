...
\begin{itemize}
      ...
      \item \textbf{Article page}: full article view, and 4 related articles.
...
\begin{itemize}
      \item Scheduled publication of content via a backoffice date picker.
            The underlying data model and backend already support future
            \texttt{published\_at} timestamps; the remaining work is
            limited to the backoffice interface.
      \item Advanced search filters (by date, category, author, tag) in
            both backoffice and public site.
