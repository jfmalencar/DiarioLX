...
This chapter reviews the context in which \textit{Diário LX} is situated. It surveys the
landscape of digital journalism platforms and the content management systems most commonly
used to build them, and assesses how well those systems meet the project's editorial,
access-control, and multimedia requirements --- motivating the decision to build a
purpose-made platform rather than adapt an existing one.
...
\section{Comparable Platforms} \label{sec:background_comparable}
...
\textit{Diari de Barcelona} is a digital newspaper operated by journalism students of the
...
\textit{A Mensagem de Lisboa} is a local newspaper, founded in 2021, that focuses on the
...
domain level. The remainder of this chapter examines the general-purpose content
...
of \textit{Diário LX}. Table~\ref{tab:cms_comparison} summarises the comparison across four
dimensions --- editorial workflow, role-based access control, multimedia support, and
frontend decoupling --- each discussed in turn below.
