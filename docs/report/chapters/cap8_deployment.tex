...
cache of a few minutes, which absorbs load on hot endpoints such as the homepage while
keeping content fresh enough for a publication that updates only a few times a day. Media objects, whose paths are
