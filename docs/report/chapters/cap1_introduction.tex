...
Diário LX is a web-based content management and publication platform
...
The system is designed around an editorial workflow in which content progresses through
defined states — draft, pending approval, published, and rejected. In the beta version,
the editorial workflow is in an advanced stage of implementation.
...
\begin{itemize}
      ...
      \item Chapter~\ref{cap:currentstate} summarises the current development status, and the work remaining for the final version.
\end{itemize}
